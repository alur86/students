...
<input id="group_id" type="hidden" class="form-control" name="group_id" value="{{ $group->id}}">
{{ csrf_field() }}
<div class="col-md-6">
...
<div class="col-md-6">
<input id="group_number" type="text" class="form-control" name="group_number" value="{{$group->group_number }}">
...
<div class="col-md-6">
<input id="course" type="text" class="form-control" name="course" value="{{$group->course}}">
